...
Файл **`NeonSlice.rbxlx`** уже лежит в корне репозитория и автоматически обновляется при каждом изменении кода.

1. Скачайте файл [**NeonSlice.rbxlx**](NeonSlice.rbxlx) прямо из репозитория (нажмите на ссылку, затем кнопку **Download**)
2. Установите [Roblox Studio](https://www.roblox.com/create) (бесплатно), если ещё не установлен
3. Откройте скачанный файл `NeonSlice.rbxlx` двойным кликом — он откроется в Roblox Studio
