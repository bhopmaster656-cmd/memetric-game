...
## ⚡ Способ 0: Самый быстрый (скачать готовый файл)

> **Файл `NeonSlice.rbxlx` не хранится в репозитории** — это собранный файл, который создаётся автоматически.
> Вы можете скачать его со страницы Releases или собрать самостоятельно с помощью Rojo.

1. Перейдите на страницу [**Releases**](../../releases) этого репозитория
2. Скачайте файл **NeonSlice.rbxlx** из последнего релиза
3. Установите [Roblox Studio](https://www.roblox.com/create) (бесплатно), если ещё не установлен
4. Откройте скачанный файл `NeonSlice.rbxlx` двойным кликом — он откроется в Roblox Studio
5. Нажмите **▶ Play** чтобы играть!

**Готово! Не нужно устанавливать Rojo или собирать проект вручную.**

---

## 📋 Что вам понадобится (для способов 1–4)
